...
/** @type {Run} */
// eslint-disable-next-line max-params -- Injectable exec adapter includes cwd and output mode.
...
// eslint-disable-next-line max-lines-per-function -- Keep the fail-closed publication sequence auditable in order.
