...
pnpm canary:first --publish --confirm @vllnt/convex-progression
```
...
Install explicitly with `pnpm add @vllnt/convex-progression@canary`.
...
```sh
npm view @vllnt/convex-progression dist-tags --registry=https://registry.npmjs.org --@vllnt:registry=https://registry.npmjs.org
npm view @vllnt/convex-progression@0.1.0-canary.0 dist.integrity --registry=https://registry.npmjs.org --@vllnt:registry=https://registry.npmjs.org
```
